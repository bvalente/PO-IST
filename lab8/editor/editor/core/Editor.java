...
public class Editor {
   ...
   * @return true if the editor contains a from with the specified identifier, false otherwise
   */
  public boolean putAsFirst(int id) throws NoSuchIdentifierException{
   ...
   * @return true if the editor contains a from with the specified identifier, false otherwise
   */
  public boolean putAsLast(int id) throws NoSuchIdentifierException{
    Form form = getForm(id);
    if (form != null) {
      _forms.remove(form);
      _forms.add(form);
